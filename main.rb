  ...
  def white_first_row
    white_first_row =
      [
        ...
        @white_knight1 = Knight.new(2, 1, 'black'), @white_knight2 = Knight.new(8, 1, 'white'),
        @white_bishop1 = Bishop.new(3, 1, 'black'), @white_bishop2 = Bishop.new(6, 1, 'white'),
        @white_queen = Queen.new(4, 1, 'black'), @white_king = King.new(5, 1, 'white')
      ]
    white_first_row
  end
